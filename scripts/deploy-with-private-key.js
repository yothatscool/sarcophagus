// VeChain Native Deployment Script with Private Key
...
async function main() {
  console.log("🏛️ Deploying with VeChain Native Tools (Private Key)...");
  ...
  if (!PRIVATE_KEY) {
    ...
    console.log("\n💡 To get your private key from VeWorld:");
    console.log("1. Open VeWorld wallet");
    console.log("2. Go to your address: 0x3d32fE6e85066240f3018c9FC664db7967d2d313");
    console.log("3. Look for 'Export Private Key' or 'Show Private Key' option");
    console.log("4. Copy the private key (without 0x prefix)");
    console.log("5. Add to your .env file: PRIVATE_KEY=your_private_key_here");
  ...
  if (account.address.toLowerCase() !== EXPECTED_ADDRESS.toLowerCase()) {
    console.log("⚠️  WARNING: The private key generates address:", account.address);
    console.log("Expected address:", EXPECTED_ADDRESS);
    console.log("These don't match! Please check your private key.");
    return;
  }

  console.log("✅ Address matches expected deployer address!");
  ...
  try {
    ...
    const deploymentInfo = {
      network: "VeChain Testnet (Native Tools - Private Key)",
    ...
    fs.writeFileSync('vechain-native-private-key-deployment.json', JSON.stringify(deploymentInfo, null, 2));
    console.log("\n📄 Deployment info saved to: vechain-native-private-key-deployment.json");

    // Display summary
    console.log("\n🎉 DEPLOYMENT COMPLETE!");
    console.log("==================================");
    console.log("Network: VeChain Testnet (Native Tools - Private Key)");
