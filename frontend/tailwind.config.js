  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Rich professional gold palette (less yellow, more golden)
        accent: {
          gold: '#b8860b',        // Rich Golden Brown (Darker Gold)
          goldLight: '#daa520',   // Goldenrod (Lighter Gold)
          goldMedium: '#cd853f',  // Peru (Medium Gold)
          goldDark: '#8b6914',    // Dark Goldenrod (Deep Gold)
      ...
      backgroundImage: {
        'gold-gradient': 'linear-gradient(135deg, #b8860b 0%, #cd853f 50%, #8b6914 100%)',
      ...
      boxShadow: {
        ...
        'gold': '0 4px 6px -1px rgba(184, 134, 11, 0.1), 0 2px 4px -1px rgba(184, 134, 11, 0.06)',
