...
interface VaultManagementModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  defaultTab?: 'deposit' | 'obol' | 'b3tr' | 'beneficiaries' | 'info' | 'nfts';
}
...
export default function VaultManagementModal({ vault, isOpen, onClose, defaultTab }: VaultManagementModalProps) {
  ...
  const [activeTab, setActiveTab] = useState<'deposit' | 'obol' | 'b3tr' | 'beneficiaries' | 'info' | 'nfts'>(defaultTab || 'deposit')
