    ...
    <div className="min-h-screen bg-sarcophagus-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-sarcophagus-800/80 backdrop-blur-sm border border-sarcophagus-700 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-accent-gold mb-3">Input Fields</h3>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2 text-sarcophagus-200">Age</label>
                <input
                  type="number"
                  className="w-full px-4 py-3 bg-sarcophagus-700 border border-sarcophagus-600 rounded-lg text-sarcophagus-100 placeholder-sarcophagus-400 focus:outline-none focus:ring-2 focus:ring-accent-gold/50 focus:border-accent-gold transition-all duration-200"
                  placeholder="Enter your age"
                />
              </div>
              <div>
                <label className="block text-sm font-medium mb-2 text-sarcophagus-200">Country</label>
                <select className="w-full px-4 py-3 bg-sarcophagus-700 border border-sarcophagus-600 rounded-lg text-sarcophagus-100 focus:outline-none focus:ring-2 focus:ring-accent-gold/50 focus:border-accent-gold transition-all duration-200">
          ...
          <div className="bg-sarcophagus-800/80 backdrop-blur-sm border border-sarcophagus-700 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-accent-gold mb-3">Color Palette</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-accent-bronze rounded"></div>
                <span className="text-sarcophagus-100">Accent Bronze</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-sarcophagus-800 rounded"></div>
                <span className="text-sarcophagus-100">Sarcophagus 800</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-sarcophagus-700 rounded"></div>
                <span className="text-sarcophagus-100">Sarcophagus 700</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Typography Demo */}
        <div className="bg-sarcophagus-800/80 backdrop-blur-sm border border-sarcophagus-700 rounded-lg p-6 mb-8">
          <h3 className="text-lg font-semibold text-accent-gold mb-4">Typography</h3>
          <div className="space-y-4">
            <div>
              <h1 className="text-3xl font-bold text-sarcophagus-100">Main Heading</h1>
              <p className="text-sarcophagus-400">This uses the system font stack</p>
            </div>
            <div>
              <h2 className="text-2xl font-semibold text-sarcophagus-100">Secondary Heading</h2>
              <p className="text-sarcophagus-400">This also uses the system font stack</p>
            </div>
            <div>
              <p className="text-sarcophagus-300 font-mono">Monospace text for addresses and technical data</p>
            </div>
          </div>
        </div>
